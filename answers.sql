...
SELECT DISTINCT name 'Pim Groeneveld' FROM people;
...
SELECT DISTINCT show_time FROM movies WHERE title = 'Guardians of the Galaxy';
INSERT INTO movies (title, year, show_time) VALUES ('Guardians of the Galaxy 2', 2018, '23:20');/q
